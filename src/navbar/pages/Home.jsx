      ...
      <div className="flex flex-row flex-wrap justify-center">
        ...
        >
          ...
          <div className='flex items-center justify-center gap-8 mt-10'>
            <button className='text-white rounded-4xl bg-purple-500 px-8 py-3 hover:bg-transparent hover:border-2 hover:border-purple-700 hover:text-purple-600 cursor-pointer transition duration-300'>Get Started</button>
